...
Config.setup do |config|
  ...
  # Default value of '.' works well with Heroku, but you might want to
  # change it for example for '__' to easy override settings from command line,
  # where using dots in variable names might not be allowed (eg. Bash).
  #
